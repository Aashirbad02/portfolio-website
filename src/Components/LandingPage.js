    ...
    <div>
      ...
      >
        <div className="pt-48">
          ...
          <div className="text-base lg:text-3xl place-content-center flex gap-x-2 p-6">
            <div>I love</div>
            <Typewriter
              options={{
                strings: [
              ...
              onInit={(typewriter) => {
                typewriter
                  ...
                  .pauseFor(800)
                  .deleteAll()
                  .typeString("Designing UI/UX")
                  .pauseFor(800)
                  .deleteAll()
                  .typeString("Participating in Hackathons")
                  .pauseFor(800)
                  .deleteAll()
                  .typeString("Writing Blogs")
                  .start();
              }}
            />
          </div>
